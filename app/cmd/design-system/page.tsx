...
import { Mail, Search, User, Settings, LogOut, ChevronDown, Plus, Trash2, Inbox, FileText, HelpCircle, Briefcase, GraduationCap, MoreVertical, Edit, Phone, MapPin, Video, Languages, Award, Eye } from 'lucide-react';
import {
  LunaButton,
  LunaCard,
  LunaCardHeader,
  ...
  return (
    <div className="min-h-screen bg-luna-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <Section title="Phone Input (LunaInput type='tel')">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
            <LunaInput
              label="Phone Number"
              type="tel"
            ...
            <LunaInput
              ...
              countryCode={phoneCountryCode}
              onCountryCodeChange={setPhoneCountryCode}
              helperText="Select country code and enter phone number"
            />
            <LunaInput
              label="With Error"
              type="tel"
          ...
          <div className="mt-4 p-4 bg-luna-gray-50 rounded-lg">
            <p className="text-sm text-luna-gray-600">
              <strong>Note:</strong> Phone inputs automatically include a country code selector when you provide the <code className="px-1 py-0.5 bg-luna-gray-100 rounded text-xs">countryCode</code> and <code className="px-1 py-0.5 bg-luna-gray-100 rounded text-xs">onCountryCodeChange</code> props. The selector includes all countries with searchable dropdown.
            </p>
          </div>
        </Section>
        ...
        <Section title="ContentCard (Learning-Specific)">
          <p className="text-sm text-luna-gray-600 mb-4">
            Specialized card component for learning content (modules, courses, programs). Used on <code className="px-1 py-0.5 bg-luna-gray-100 rounded text-xs">/u/learning</code> page.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <ContentCard
              ...
              isFree={true}
              isEnrolled={false}
              creatorName="Luna Academy"
              creatorLogo="/img/Luna_logo_dark.PNG"
              contentType="module"
              itemCount={12}
            ...
            <ContentCard
              ...
              description="Comprehensive program covering frontend, backend, databases, and deployment strategies."
              coverImage="/img/Luna_logo_dark.PNG"
              level="intermediate"
              duration={1200}
              price={299.99}
              isFree={false}
              isEnrolled={false}
              hasPendingScholarship={true}
              creatorName="Code Institute"
              creatorLogo="/img/Luna_logo_dark.PNG"
              onView={() => console.log('View clicked')}
            />
            ...
            <ContentCard
              ...
              description="Learn advanced techniques to optimize React applications for maximum performance and user experience."
              coverImage="/img/Luna_logo_dark.PNG"
              level="advanced"
              duration={300}
              price={79.99}
            ...
            <ContentCard
              ...
              description="Master the principles of user interface and user experience design to create beautiful, intuitive applications."
              coverImage="/img/Luna_logo_dark.PNG"
              level="beginner"
              duration={150}
              price={39.99}
              ...
              creatorLogo="/img/Luna_logo_dark.PNG"
              onContinue={() => console.log('Review clicked')}
            />
            ...
            <ContentCard
              ...
              description="Learn how to design efficient database schemas and write complex SQL queries for data manipulation."
              level="intermediate"
              duration={200}
              price={59.99}
              isFree={false}
              isEnrolled={false}
              creatorName="Data School"
              onView={() => console.log('View clicked')}
              onEnroll={() => console.log('Enroll clicked')}
            />
          </div>
        ...
        <Section title="LunaDataTable">
          <LunaCard>
            <LunaCardHeader>
              <LunaCardTitle>Sample Data Table</LunaCardTitle>
            </LunaCardHeader>
            <LunaCardContent>
              <LunaDataTableToolbar
                ...
                actionsColumn={(row) => (
                  <LunaDropdownMenu>
                    ...
                    <LunaDropdownMenuContent align="end">
                      <LunaDropdownMenuItem onClick={() => console.log('Edit:', row)}>
        ...
        {/* Section Label */}
        <Section title="LunaSectionLabel">
          <Showcase label="Section Labels with Separator">
            <div className="space-y-6 w-full max-w-2xl">
              <LunaCard>
                <LunaSectionLabel label="Languages" />
                <p className="text-sm text-luna-gray-600">Content goes here...</p>
              </LunaCard>
              <LunaCard>
              ...
              <LunaCard>
                <LunaSectionLabel label="Skills" />
                <p className="text-sm text-luna-gray-600">Content goes here...</p>
              </LunaCard>
            </div>
          </Showcase>

          <Showcase label="With Empty State">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              <LunaCard>
                ...
                <LunaEmptyState
                  ...
                  description="Click the button below to add the languages you speak"
                  action={<LunaButton variant="outline" size="sm"><Plus className="w-4 h-4 mr-2" />Add new</LunaButton>}
                  size="sm"
                />
              </LunaCard>
              <LunaCard>
        ...
        <Section title="LunaEmptyState">
          <Showcase label="Basic Empty States (No Background)">
          ...
          <Showcase label="With Background Container (Figma Style)">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              <LunaCard>
                <LunaEmptyState
                  icon={Video}
          ...
          <Showcase label="Icon Background Colors">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
              <LunaCard>
                <LunaEmptyState
                  icon={Briefcase}
              ...
              <LunaCard>
                <LunaEmptyState
                  ...
                  description="Add your certifications and training"
                  action={<LunaButton variant="outline" size="sm"><Plus className="w-4 h-4 mr-2" />Add new</LunaButton>}
                  size="lg"
                />
              </LunaCard>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
              <LunaCard>
                <LunaEmptyState
                  ...
                  showBackground
                  title="Small"
                  description="Compact empty state for sidebars"
                  size="sm"
                />
              </LunaCard>
              <LunaCard>
